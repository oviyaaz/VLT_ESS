...
// const HrSupervisorAttendanceReset = () => {
...
//         `${apiBaseUrl}/admin/supervisor-reset-requests/`
//       );
...
//     try {
//       await axios.post(
//         `${apiBaseUrl}/admin/approve-and-reset-supervisor-reset-request/${requestId}/`
//       );
...
//     try {
//       await axios.post(
//         `${apiBaseUrl}/admin/reject-supervisor-reset-request/${requestId}/`
//       );
...
//     { field: "supervisor_id", headerName: "Supervisor ID", width: 150 },
...
//         <h2 className="font-semibold">Supervisor Attendance Reset Requests</h2>
//         <div className=""></div>
//       </div>
...
// export default HrSupervisorAttendanceReset;
  ...
  return (
    <div className="border rounded p-4">
      <h2 className="font-semibold mb-4">
        Supervisor Attendance Reset Requests
      </h2>
      <Table>
        <TableHeader>
          <TableRow>
          ...
          {resetRequests.length > 0 ? (
            resetRequests.map((request, index) => (
              <TableRow key={request.id}>
                ...
                <TableCell>{request.supervisor_id}</TableCell>
