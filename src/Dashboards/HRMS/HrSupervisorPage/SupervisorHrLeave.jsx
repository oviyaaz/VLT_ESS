...
//         `${apiBaseUrl}/supervisor-leave-status/?${queryParams}`
//       );
//       setSupervisorLeaveList(
//         (data || []).map((leave) => ({
//           id: leave.id,
//           user: leave.user,
...
//     try {
//       const response = await axios.post(`${apiBaseUrl}/supervisor-leave-status/`, {
...
//     try {
//       await axios.delete(`${apiBaseUrl}/delete_supervisor_leave/${row.id}/`);
...
//       <h3 className="">Supervisor Leave List</h3>
...
// export default SupervisorHrLeave;
import React, { useEffect, useState } from "react";
import axios from "axios";
import { toast } from "react-toastify";
import {
