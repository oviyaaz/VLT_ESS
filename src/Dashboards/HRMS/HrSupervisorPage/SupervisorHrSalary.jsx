...
//     try {
//       await axios.delete(`${apiBaseUrl}/delete-supervisor-salary/${row.id}/`);
...
// export default SupervisorHrSalary;
  ...
  const fetchSalaryList = async () => {
    try {
      const { data } = await axios.get(
        `${apiBaseUrl}/supervisor-salary/history/`,
      );
      setSalaryList(data);
    } catch (error) {
