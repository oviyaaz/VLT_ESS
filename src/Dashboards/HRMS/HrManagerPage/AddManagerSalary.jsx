  ...
  const HandleAddSalary = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        `${apiBaseUrl}/salary/manager-create/`,
        SalaryData,
        {
          headers: {
      ...
      fetchSalaryList();
      toast.success(`Add salary successfully`);
    } catch (error) {
      console.error(error);
    ...
    <>
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 items-center justify-center z-50">
        <div className="bg-white rounded-lg p-8 w-full max-w-2xl mx-4 shadow-xl">
          <h1 className="text-2xl font-semibold mb-6">Add Manager Salary</h1>
