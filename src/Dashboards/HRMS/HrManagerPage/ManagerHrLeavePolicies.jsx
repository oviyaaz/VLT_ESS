...
//         await axios.put(
//           `${apiBaseUrl}/edit_manager_leave_balance/${selectedLeaveId}/`,
//           {
...
//       } else {
//         // Add new leave balance for the selected manager
//         await axios.post(
...
//         <h2 className="text-2xl font-semibold">Manager Leave Policies</h2>
