...
// const EmployeeHrAttendanceReset = () => {
...
//         `${apiBaseUrl}/admin/employee-reset-requests/`
//       );
...
//     try {
//       await axios.post(
//         `${apiBaseUrl}/admin/approve-and-reset-employee-reset-request/${requestId}/`
//       );
...
//     try {
//       await axios.post(
//         `${apiBaseUrl}/admin/reject-employee-reset-request/${requestId}/`
//       );
...
//         <h2 className="font-semibold">Employee Attendance Reset Requests</h2>
//         <div className=""></div>
//       </div>
...
// export default EmployeeHrAttendanceReset;
import React, { useEffect, useState } from "react";
import axios from "axios";
import { Button } from "@mui/material";
import {
...
const EmployeeAttendanceReset = () => {
  ...
  return (
    <div className="border rounded p-4">
      <h2 className="font-semibold mb-4">Employee Attendance Reset Requests</h2>
      <Table>
        <TableHeader>
          <TableRow>
