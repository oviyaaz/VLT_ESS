...
//         <h2 className="text-2xl font-semibold">Employee Leave Policies</h2>
...
// export default EmpHrLeavePolicies;
...
const EmpLeavePolicies = () => {
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this leave policy?")) {
      try {
        await axios.delete(
          `${apiBaseUrl}/delete_employee_leave_balance/${id}/`,
        );
        toast.success("Leave policy deleted successfully.");
        fetchLeavePolicies();
      } catch (error) {
