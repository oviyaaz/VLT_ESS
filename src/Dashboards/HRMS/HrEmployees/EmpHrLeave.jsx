...
//         `${apiBaseUrl}/employee-leave-status/?${queryParams}`
//       );
...
//     try {
//       await axios.delete(`${apiBaseUrl}/delete_employee_leave/${row.id}/`);
...
//       <h3 className="">Employee Leave List</h3>
...
const EmpLeave = () => {
  ...
  const handleStatusChange = async (status, leaveId) => {
    try {
      const response = await axios.post(
        `${apiBaseUrl}/employee-leave-status/`,
        {
          leave_id: leaveId,
  ...
  return (
    <div className="h-full min-h-screen p-4 overflow-y-scroll">
      <h3 className="mb-4">Employee Leave List</h3>
