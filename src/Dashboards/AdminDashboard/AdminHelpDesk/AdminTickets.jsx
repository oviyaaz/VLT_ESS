...
import { GetAdminTicketRequestList } from "@/api/ServerAction";
...
export default function AdminTickets() {
  ...
  const categories = ["HR", "Supervisor", "Manager", "Employee", "System", "Others"];
  ...
  useEffect(() => {
    const fetchTickets = async () => {
      ...
      try {
        const tickets = await GetAdminTicketRequestList();
        const mappedTickets = tickets.map((ticket) => ({
          ...
          name: ticket.hr_id ? ticket.hr_name || "N/A" :
                ticket.supervisor_id ? ticket.supervisor_name || "N/A" :
          ...
          category: ticket.ticket_id.startsWith('TKT-OTH') ? "Others" :
                    ticket.hr_id ? "HR" :
                    ticket.supervisor_id ? "Supervisor" :
