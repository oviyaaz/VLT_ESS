...
const AddManagerSalary = ({ open, setOpen, ManagerList, fetchSalaryList }) => {
  ...
  const HandleAddSalary = async (e) => {
    ...
    try {
      await axios.post(`${apiBaseUrl}/salary/manager-create/`, SalaryData, {
        headers: {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold">Add Manager Salary</DialogTitle>
        </DialogHeader>
...
export default AddManagerSalary;