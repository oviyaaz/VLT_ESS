...
const AddManagerHRSalary = ({ open, setOpen, HrList, fetchSalaryList }) => {
  ...
  const HandleAddSalary = async (e) => {
    ...
    try {
      await axios.post(`${apiBaseUrl}/salary/hr-create/`, SalaryData, {
        headers: {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold">Add HR Salary</DialogTitle>
        </DialogHeader>
...
export default AddManagerHRSalary;