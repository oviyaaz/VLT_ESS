...
const AddManagerARSalary = ({ open, setOpen, ArList, fetchSalaryList }) => {
  ...
  const HandleAddSalary = async (e) => {
    ...
    try {
      await axios.post(`${apiBaseUrl}/salary/ar-create/`, SalaryData, {
        headers: {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold">Add AR Salary</DialogTitle>
        </DialogHeader>
...
export default AddManagerARSalary;