...
useEffect(() => {
  ...
  const handleSelectParty = (partyIdOrIndex) => {
    navigate(`/employee/billing/partydetails/${partyIdOrIndex}`);
  };

 
  const handleEditParty = () => {
    if (!party) return;
    navigate(`/employee/billing/createparty?editId=${party.id}`);
  };
            ...
            <div className="flex justify-between items-start">
              ...
              <div className="text-right">
                ...
                <button
                  onClick={(e) => {
                    e.preventDefault();
                    navigate(`/employee/billing/createparty?editId=${party.id}&manageShipping=1`);
                  }}
