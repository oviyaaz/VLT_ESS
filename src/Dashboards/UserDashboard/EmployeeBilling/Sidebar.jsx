...
const menuItems = [
  ...
  // },
  {
    ...
    icon: <FaShoppingCart />,
    children: [
      { label: "Sales Invoices", path: "/employee/billing/salesinvoice" },
      { label: "Quotation / Estimate", path: "/employee/billing/quotationestimate" },
      { label: "Payment In", path: "/employee/billing/paymentin" },
      //{ label: "Sales Return", path: "/salesreturn" },
      { label: "Credit Note", path: "/employee/billing/creditinvoice" },
      { label: "Delivery Challan", path: "/employee/billing/deliverychallen" },
