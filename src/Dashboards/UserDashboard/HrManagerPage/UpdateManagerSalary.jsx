    ...
    const fetchSalaryDetails = async () => {
      ...
      try {
        const response = await axios.get(
          `${apiBaseUrl}/get-manager-salary/${salaryId}/`,
        );
  ...
  const HandleUpdateSalary = async (e) => {
    ...
    try {
      const response = await axios.put(
        `${apiBaseUrl}/update-manager-salary/${salaryId}/`,
        formattedData,
  ...
  return (
    <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 items-center justify-center z-50">
      <div className="bg-white rounded-lg p-8 w-full max-w-2xl mx-4 shadow-xl">
        <h1 className="text-2xl font-semibold mb-6">Update Manager Salary</h1>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 items-center gap-2 w-full">
                  ...
                  <select
                    className="w-full px-3 py-2 rounded-md border col-span-2"
                ...
                <div className="grid grid-cols-3 items-center gap-2 w-full">
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 rounded-md border col-span-2 ${errors.annual_salary && "border-red-500"}`}
                ...
                <div className="grid grid-cols-3 items-center gap-2 w-full">
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 rounded-md border col-span-2 ${errors.bonus && "border-red-500"}`}
                ...
                <div className="grid grid-cols-3 items-center gap-2 w-full">
                  ...
                  <input
                    type="month"
                    className={`w-full px-3 py-2 rounded-md border col-span-2 ${errors.effective_date && "border-red-500"}`}
                    value={SalaryData.effective_date.slice(0, 7)}
                    onChange={(e) =>
                      setSalaryData({
                        ...SalaryData,
...
export default UpdateManagerSalary;
