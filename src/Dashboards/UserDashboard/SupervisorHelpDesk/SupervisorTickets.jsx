...
import { GetSupervisorTicketRequestList } from "@/api/ServerAction";
...
export default function SupervisorTickets() {
  ...
  const categories = ["Manager", "Employee", "System"];
  ...
  useEffect(() => {
    const fetchTickets = async () => {
      ...
      try {
        const tickets = await GetSupervisorTicketRequestList();
